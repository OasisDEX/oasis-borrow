...
export const summerFadedBrandGradient =
  'linear-gradient(90deg, #b2d8e3 0%, #f8e4d8 50%, #f8d4c7 100%)'
export const summerLightBrandGradient = 'linear-gradient(92.03deg, #FFF3EF 0.78%, #F2FCFF 99.57%)'
