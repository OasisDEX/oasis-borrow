...
export interface Vault<Ilk> {
   ...
   */
  backingCollateral: BigNumber // Currency
   ...
   */
  debt: BigNumber // Currency - iDAI - internal Dai Currency<DAI, 45>
   ...
   */
  availableIlkDebt: BigNumber // iDai
   ...
   */
  liquidationRatio: BigNumber // Ratio
   ...
   */
  collateralizationRatio: BigNumber | undefined // Ratio
   ...
   */
  tokenOraclePrice: BigNumber // Price
   ...
   */
  liquidationPrice: BigNumber | undefined // Price
   ...
   */
  liquidationPenalty: BigNumber // Ratio
