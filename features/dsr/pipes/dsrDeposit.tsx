...
import { approve, ApproveData } from '../helpers/erc20Calls'
import { DsrJoinData, join } from '../helpers/potCalls'
...
function deposit(
  ...
  // TODO: Sort out type issues on these any types
  sendWithGasEstimation(join as any, {
    kind: TxMetaKind.dsrJoin as any,
