...
describe('userSettings', () => {
  ...
  it(
    'should start in editing stage and with default slippage if local storage is empty',
    () => {
  ...
  it(
    'should validate if slippage is outside of valid range (0.2-0.001) and block progression',
    () => {
  ...
  it(
    'should validate if slippage is valid and over warning threshold (0.05)',
    () => {
      const newSlippage = new BigNumber(0.1)
      const state = mockUserSettings()
  ...
  it(
    'should save slippage, progress to success state and handle reset',
    () => {
      const newSlippage = new BigNumber(0.1)
      const state = mockUserSettings()
