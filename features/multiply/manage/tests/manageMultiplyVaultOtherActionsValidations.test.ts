...
describe('manageVaultOtherActionsValidations', () => {
  ...
  it(
    `validates if generate amount is putting vault at risk, danger or exceeding day yield`,
    () => {
  ...
  it(
    `validates if withdraw amount is putting vault at risk, danger or exceeding free collateral`,
    () => {
  ...
  it(
    'validates if dai allowance is enough to payback whole amount and account debt offset',
    () => {
  ...
  it(
    'should show meaningful message when trying to withdraw collateral on dusty vault',
    () => {
  ...
  it(
    'validates if vault has no collateral and show correct error message',
    () => {
      const state = getStateUnpacker(
        mockManageMultiplyVault$({
          vault: {
  ...
  it(
    'validates if next coll ratio on collateral withdraw is below stop loss level',
    () => {
  ...
  it(
    'validates if next coll ratio on dai withdraw is below stop loss level',
    () => {
      localStorage.setItem('features', '{"Automation":true}')
