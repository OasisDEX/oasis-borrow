...
describe('manageVaultAdjustPositionValidations', () => {
  ...
  it(
    'validates if required collateralization ratio is putting vault at risk, danger or exceeding day yield',
    () => {
  ...
  it(
    'validates if required collateralization ratio is putting vault at risk, danger or exceeds dai yield from total collateral at next price',
    () => {
  ...
  it(
    `validates if adjust action doesn't exceeds debt ceiling, debt floor`,
    () => {
  ...
  it(
    'validates if vault has no collateral and can`t progress on adjust position',
    () => {
      const state = getStateUnpacker(
        mockManageMultiplyVault$({
          vault: {
