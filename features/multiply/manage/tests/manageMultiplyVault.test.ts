...
describe('manageMultiplyVault', () => {
  describe('manageMultiplyVault$', () => {
    describe('adjust position', () => {
      ...
      it(
        'should start by default in an other actions deposit collateral if vault has zero collateral',
        () => {
    ...
    describe('other actions', () => {
      ...
      it(
        'should update deposit amount, deposit amount USD, deposit max with collateral balance and reset value on otherAction change',
        () => {
      ...
      it(
        'should update withdraw amount, withdraw amount USD and withdraw max  and reset value on otherAction change',
        () => {
      ...
      it(
        'should update generate amount amount, generate amount max and reset value on otherAction change',
        () => {
      ...
      it(
        'should be able to go to closeVault and toggle between collateral and DAI',
        () => {
          const state = getStateUnpacker(
            mockManageMultiplyVault$({
              vault: {
    ...
    describe('editing progressions', () => {
      it(
        'should progress from adjust position to manage vault confirmation',
        () => {
          const state = getStateUnpacker(
            mockManageMultiplyVault$({
              vault: {
      ...
      it(
        'should progress from otherAction to collateralAllowance flow if user has proxy but insufficent allowance for deposit amount',
        () => {
          const depositAmount = new BigNumber('5')
      ...
      it(
        'should progress from otherAction to daiAllowance flow if user has proxy but insufficent allowance for payback amount',
        () => {
      ...
      it(
        'should update totalSteps if allowances amount are less than deposit or payback amount depending on otherAction',
        () => {
    ...
    describe('multiply to borrow transitions', () => {
      ...
      it(
        'should handle previously selected editing stage when going back and forth from borrow transition stages',
        () => {
          const state = getStateUnpacker(mockManageMultiplyVault$())
          expect(state().stage).toBe('adjustPosition')
