...
describe('InstitutionalBorrowManageAdapter', () => {
  describe('increasingRisk', () => {
    it(
      'shows as risk not increasing when increasing collateralisation ratio',
      () => {
    ...
    it(
      'shows as risk increasing when decreasing collateralisation ratio',
      () => {
        const result = increasingRisk({
          inputAmountsEmpty: false,
    ...
    it(
      'shows as risk increasing when only next price col ratio decreasing',
      () => {
        const result = increasingRisk({
          inputAmountsEmpty: true,
          afterCollateralizationRatioAtNextPrice: new BigNumber(1.5),
    ...
    it(
      'shows as risk not increasing when taking vault from coll ratio to zero (zero col ratio means no debt drawn - infinite col ratio)',
      () => {
        const result = increasingRisk({
          inputAmountsEmpty: false,
    ...
    it(
      'shows as risk increasing when increasing col ratio from zero (zero col ratio means no debt drawn - infinite col ratio)',
      () => {
        const result = increasingRisk({
          inputAmountsEmpty: false,
          afterCollateralizationRatioAtNextPrice: new BigNumber(1.5),
