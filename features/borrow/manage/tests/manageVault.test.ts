...
function genericManageVaultTests(mockManageVault$: typeof createManageVault$) {
  describe('editing collateral', () => {
    ...
    it(
      'should update deposit amount, deposit amount USD and deposit max with collateral balance',
      () => {
    ...
    it(
      'should update generate amount amount and generate amount max when depositAmount is defined & option is true',
      () => {
        const depositAmount = new BigNumber('5')
    ...
    it(
      'should update generate max amount when depositAmount is defined & option is true',
      () => {
        const depositAmount = new BigNumber('5')
    ...
    it(
      'should update withdraw amount, withdraw amount USD and withdraw max',
      () => {
    ...
    it(
      'should update payback amount when withdrawAmount is defined & option is true',
      () => {
        const withdrawAmount = new BigNumber('5')
    ...
    it(
      'should update payback amount max when withdrawAmount is defined & option is true',
      () => {
        const withdrawAmount = new BigNumber('5')
  ...
  describe('editing dai', () => {
    ...
    it(
      'should update depositAmount when generateAmount is defined & option is true',
      () => {
        const depositAmount = new BigNumber('5')
        const generateAmount = new BigNumber('3000')
    ...
    it(
      'should update withdrawAmount when paybackAmount is defined & option is true',
      () => {
        const withdrawAmount = new BigNumber('5')
        const paybackAmount = new BigNumber('1000')
  ...
  describe('editing progressions', () => {
    it(
      'should progress from collateral editing to manage vault confirmation',
      () => {
        const depositAmount = new BigNumber('5')
        const generateAmount = new BigNumber('3000')
    ...
    it(
      'should progress from editing to proxyWaitingForConfirmation if no proxy exists',
      () => {
        const depositAmount = new BigNumber('5')
        const generateAmount = new BigNumber('3000')
    ...
    it(
      'should progress from editing to collateralAllowance flow if user has proxy but insufficent allowance for deposit amount',
      () => {
        const depositAmount = new BigNumber('5')
        const generateAmount = new BigNumber('3000')
    ...
    it(
      'should progress from editing to daiAllowance flow if user has proxy but insufficent allowance for payback amount',
      () => {
    ...
    it(
      'shold update totalSteps if allowances amount are less than deposit or payback amount',
      () => {
    ...
    it(
      'shold decrease totalSteps if user skips collateral deposit and has enough dai allowance to payback',
      () => {
        const daiAllowance = new BigNumber('1000')
  ...
  describe('create proxy flow', () => {
    ...
    it(
      'should handle proxy success case and progress to collateralAllowanceWaitingForConfirmation',
      () => {
    ...
    it(
      'should handle proxy success case and progress to daiAllowanceWaitingForConfirmation',
      () => {
        const _proxyAddress$ = new Subject<string>()
  ...
  describe('manage allowances', () => {
    it(
      'should handle collateral allowance inputs, going back and forth and setting collateral allowance',
      () => {
        const depositAmount = new BigNumber('5')
    ...
    it(
      'should handle dai allowance inputs, going back and forth and setting dai allowance',
      () => {
        const paybackAmount = new BigNumber('5')
        const customAllowanceAmount = new BigNumber(10)
  ...
  describe('multiply transitions', () => {
    ...
    it(
      'should handle previously selected editing stage when going back and forth from multiply transition stages',
      () => {
        const state = getStateUnpacker(mockManageVault$())
        expect(state().stage).toBe('collateralEditing')
...
describe('manageVault', () => {
  ...
  describe('managing institutional vaults', () => {
    ...
    it(
      'blocks user progressing when they will go under min active col ratio at current price',
      () => {
    ...
    it(
      'blocks user progressing when they will go under min active col ratio at next price',
      () => {
        // construct over-collateralised vault
        const { instiVault$ } = mockVault$({
          debt: new BigNumber(10000),
        ...
        expect(state().vaultWillBeTakenUnderMinActiveColRatio).toBe(true)
        expect(state().errorMessages.length).toBe(2)
        expect(state().errorMessages[0]).toBe('generateAmountExceedsDaiYieldFromTotalCollateralAtNextPrice')
        expect(state().errorMessages[1]).toBe('vaultWillBeTakenUnderMinActiveColRatio')
        expect(state().canProgress).toBe(false)
      }
    )
    ...
    it(
      'warns users when position will be undercollaterlised at next price',
      () => {
    ...
    it(
      'allows users to decrease risk on under-collateralised (min active) position',
      () => {
        // construct under-collateralised vault (min active col ratio)
        const { instiVault$ } = mockVault$({
          debt: new BigNumber(10000),
        ...
        expect(state().errorMessages.length).toBe(0)
        expect(state().warningMessages.length).toBe(1)
        expect(state().warningMessages).toEqual(expect.arrayContaining(['vaultIsCurrentlyUnderMinActiveColRatio']))
        ...
        expect(state().warningMessages).toEqual(expect.arrayContaining(['vaultWillRemainUnderMinActiveColRatio']))
        expect(state().warningMessages).toEqual(expect.arrayContaining(['vaultIsCurrentlyUnderMinActiveColRatio']))
  ...
  it(
    'errors when the current collateral would not allow any debt to be drawn from the vault',
    () => {
      const state = getStateUnpacker(
        mockManageVault$({
          vault: {
