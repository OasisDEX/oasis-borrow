...
export default () => (
  <FaqLayout learnMoreUrl={EXTERNAL_LINKS.KB.STETH_AAVE_V3_EMODE}>
    ...
    <Text variant="paragraph1">
      ...
      impact the returns. Summer.fi will announce Governance changes from AAVE that affect this
      strategy. Since ETH interest rates are variable, the profitability of this strategy changes
      with the demand to borrow ETH in AAVE.
    </Text>
    ...
    <Text variant="paragraph1">
      ...
      by increasing exposure to StETH by borrowing ETH in AAVE v3. An ongoing cost of the variable
      ETH borrowing rate in AAVE must be continually paid. This means that the strategy remains
    ...
    <Text variant="paragraph1">
      ...
      smart contracts: All capital is deposited to AAVE v3 protocol and held there for the strategy
      to work. Wrapped StETH represents ETH held by Lido, which in turn gives it to the node
      operators that perform the validator duties for Lido.
    </Text>
    ...
    <Text variant="paragraph1">
      ...
      interest on the ETH borrowed from AAVE. This variable fee is accounted for in the net APY, but
      it changes continually as the market demands more or less ETH. Users need to take into account
      gas costs related to the Ethereum network, which vary with congestion and ETH price.
    </Text>
