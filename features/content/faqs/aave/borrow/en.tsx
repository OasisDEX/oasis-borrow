...
export default () => (
  <FaqLayout
    ...
    contents={[
      {
        title: 'What is Summer.fi Borrow with Aave?',
        body: (
          <Text>
            Summer.fi borrow with Aave allows you to easily borrow against your crypto collateral.
            ...
            way. Aave v3 loans are perpetual with a variable interest rate. The collateral is
            deposited in Aave v3 on which you receive some interest, whilst you are paying an
        ...
        body: (
          <>
            <Text>
              ...
              Within the transaction you will deposit your collateral to Aave v3, and borrow the
            ...
            <Text>
              ...
              , each Summer.fi Borrow with Aave position will use a single Smart Defi Account to
        ...
        body: (
          <>
            <Text>
              ...
              monitor your position to avoid liquidations. Aave has a buffer between the maximum LTV
              and the liquidation threshold to give you some time to repay your debt.
            </Text>
            <Text>
              ...
              be aware that the Aave protocol also has governance risk, this means that decisions
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <ol>
              <li>
                Maker & Aave both use oracles. Maker has a 1-hour delay between oracle updates. This
                means that a position only becomes uncollateralized with a one-hour delay, allowing
                you more time to unwind your position. For Aave, liquidations are instantaneous, but
                this allows the protocol to have a lower penalty fee for liquidation. The
                liquidation penalty for each asset can be seen in the liquidation price tooltip.
                Maker uses its own oracle network to report prices, while Aave utilizes Chainlink
                services. Ajna does not use internal oracles.
              </li>
              <li>
      ...
      },
      {
        ...
        body: (
          <>
            <Text>Depositing and borrowing actions are completely free of charge!</Text>
            <Text>
              When you are using the one-click risk adjustment actions available in multiply,
              Summer.fi charges a fee of 0.2% over the required swap. We source free flash loans
              from multiple providers to guarantee the best execution. Your Borrow position will pay
              a variable borrowing fee to Aave and will get paid a variable lending fee for
              providing liquidity to Aave. You can see this in your 'Net Borrowing Cost' in the main
              view. As usual, Ethereum gas fees will apply, with the value dependent on the network
              conditions.
            </Text>
          </>
        ),
