...
export default () => (
  <FaqLayout
    ...
    contents={[
      {
        title: 'How does Ajna Multiply work?',
        body: (
          <>
            <Text>
              Ajna is a unique lending protocol with no oracles and no governance. Each Multiply
              position is tied to a single collateral/debt pair. You can increase risk in your
              position up to the dynamic max LTV offered by the collective of pool lenders. The
              dynamic max LTV is set by the market activity, completely autonomously from any
              governance. Volatility, market demand and asset risk evaluation done by lenders
              converges on an offered max LTV, even if this changes, you, as a borrower are in
              control at all times of your liquidation price. Without oracles, liquidators are
              forced to post a bond to ensure liquidations only happen on bad loans. Rates are
              variable set by the pool utilization, there is no repayment schedule and listing of
              tokens happens permissionless.
            </Text>
        ...
        body: (
          <>
            <Text>
              ...
              has passed, the loan will be moved to a liquidation auction where the collateral will
              be sold to cover the debt and a 7% penalty will be applied. If the loan is
              successfully liquidated, the debt will be recovered and any collateral left will be
              left for you to withdraw. Liquidations can happen partially and in cases where a loan
              collateralized during the auction it will be moved out of it. At all times during this
              process you can repay your debt or add more collateral to recollateralize your
              position.
            </Text>
          </>
        ),
