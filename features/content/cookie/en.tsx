  ...
  return (
    ...
    >
      ...
      <Text as="p">
        ...
        typically stored on your computer's hard drive. Information collected from cookies is used
        by us to evaluate the effectiveness of our Site and analyze trends. The information
      ...
      <Text as="p">
        ...
        select that will educate us on such things as how visitors navigate around our Site. This
        information is aggregated to provide statistical data about our users' browsing actions and
      ...
      <Text as="p">
        ...
        interests, as well as help ensure secure use of the website for all users. If you want to
        avoid using cookies altogether, you can disable cookies in your browser or express your
        choices in the cookie management interface. However, disabling cookies might make it
        impossible for you to use certain features of the Site. Your use of the Site with a browser
        that is configured to accept cookies constitutes acceptance of our and third-party cookies.
      </Text>
      ...
      <Text as="p">
        ...
        data concerned; where possible, the envisaged period for which the personal data will be
        processed, or, if not possible, the criteria used to determine that period; the existence of
        the right to request from us rectification or erasure of personal data, or restriction of
        processing of personal data concerning you, or to object to such processing; the existence
        of the right to lodge a complaint with a supervisory authority; where the personal data are
        not collected directly from you, any available information as to their source; and the
        existence of automated decision-making, including profiling, and, at least in those cases,
      ...
      <Text as="p">
        ...
        processing, which override the interests, rights and freedoms of you, or for the
      ...
      <Text as="p">
        ...
        the same level of data protection. In such circumstances, we ensure that such transfers are
        subject to appropriate safeguards. As personal data processors, they are obliged to protect
        data privacy to the same extent as we ourselves. We choose the processors carefully to
      ...
      <Text as="p">
        ...
        apply to the websites of third parties and the corresponding links given on the Site. We
      ...
      <ul>
        <li>
          <AppLink href="https://support.google.com/accounts/answer/61416?co=GENIE.Platform%3DDesktop&hl=en">
            Google Chrome
          </AppLink>
        </li>
        <li>
          <AppLink href="https://support.microsoft.com/en-us/help/4468242/microsoft-edge-browsing-data-and-privacy-microsoft-privacy">
            Microsoft Edge
          </AppLink>
        </li>
        <li>
          <AppLink href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences">
            Mozilla Firefox
          </AppLink>
        </li>
        <li>
          <AppLink href="https://support.microsoft.com/en-gb/help/17442/windows-internet-explorer-delete-manage-cookies">
            Microsoft Internet Explorer
          </AppLink>
        </li>
        <li>
          <AppLink href="https://help.opera.com/en/latest/">Opera</AppLink>
        </li>
        <li>
      ...
      <Text as="p">
        ...
        browser. It is therefore not a solution that allows you to refuse cookies; however, their
      ...
      <table>
        ...
        <tr>
          ...
          <td>First party</td>
          <td>Next-i18next</td>
          <td>Sets the language setting of the application</td>
          <td>Session</td>
        </tr>
      </table>
      <Text as="p" sx={{ textDecoration: 'italic' }}>
      ...
      <Text as="p">
        ...
        collected by these cookies is aggregated and therefore anonymised. If you do not accept
      ...
      <table>
        ...
        <tr>
          <td>Groove</td>
          <td>Third party</td>
          <td>_ga_B62KEY1NJQ</td>
          <td>Analytics of the knowledge base</td>
          <td>22 months</td>
        </tr>
        <tr>
          <td>Groove</td>
        ...
        <tr>
          <td>Mixpanel</td>
          <td>Third party</td>
          <td>mp_5372a8300dc764fd08c9bd883eaf6</td>
          <td>Analytics for Summer.fi</td>
          <td>12 months</td>
        </tr>
        <tr>
          <td>Mixpanel</td>
          <td>Third party</td>
          <td>mp_b10850880cb0a8557d878c2e602</td>
          <td>Analytics for Summer.fi</td>
          <td>12 months</td>
        </tr>
        <tr>
          <td>Mixpanel</td>
          <td>Third party</td>
          <td>mp_eceeaac79053a2f9538c8e404607c4</td>
          <td>Analytics for Summer.fi</td>
          <td>12 months</td>
        </tr>
      </table>
      ...
      <Text as="p">
        ...
        identification of your browser and Internet device. If you do not allow these cookies, your
