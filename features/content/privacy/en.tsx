...
export default () => (
  ...
  >
    ...
    <Text as="p">
      ...
      collectively in order to improve our product user experience. We may also use this data to
      facilitate individual access to the Site, Services and linked third-party websites,
    ...
    <Text as="p">
      ...
      level of data protection. In such circumstances, we ensure that such transfers are subject to
      appropriate safeguards. As personal data processors, they are obliged to protect data privacy
      to the same extent as we ourselves. We choose the processors carefully to ensure compliance
