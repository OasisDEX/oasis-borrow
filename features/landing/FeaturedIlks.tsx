...
function getIlksToken(ilks: IlkData[]) {
  const tokens = Array.from(new Set(ilks.map((ilk) => ilk.token)))
}

export function CollateralCard({ onClick, collateral, ilks }: CollateralCardProps) {
