...
import type { OmniValidationItem } from 'features/omni-kit/types/common.types'
import { useTranslation } from 'next-i18next'
import type { FC } from 'react'
import React from 'react'

interface OmniValidationMessagesProps {
  validations: OmniValidationItem[]
  type: 'warning' | 'error' | 'notice' | 'success'
}

export const OmniValidationMessages: FC<OmniValidationMessagesProps> = ({ validations, type }) => {
