...
interface OmniContentCardLtvModalProps {
...
function OmniContentCardLtvModal({
  loanToValue,
...
export function OmniContentCardLtv({
  ...
  const contentCardModalSettings: OmniContentCardLtvModalProps = {
    loanToValue,
    maxLoanToValue,
    liquidationThreshold,
    isAutomationAvailable,
  ...
  const contentCardSettings: ContentCardProps = {
    ...
    customBackground:
      afterLoanToValue && !liquidationThreshold.eq(zero)
        ...
        : 'transparent',
    modal: <OmniContentCardLtvModal {...contentCardModalSettings} />,
  }
