...
import {
  makerActionDepositBorrow,
  makerActionOpenBorrow,
  makerActionPaybackWithdraw,
} from 'features/omni-kit/protocols/maker/actions/borrow'
import {
  makerActionAdjust,
  makerActionClose,
  makerActionOpenMultiply,
} from 'features/omni-kit/protocols/maker/actions/multiply'
import { getMakerCumulatives } from 'features/omni-kit/protocols/maker/helpers/getMakerCumulatives'
...
export const getMakerParameters = async ({
  state,
  rpcProvider,
  networkId,
  isFormValid,
  ...
  switch (action) {
    ...
    case OmniMultiplyFormAction.OpenMultiply: {
      ...
      return makerActionOpenMultiply({
        state,
    ...
    case OmniMultiplyFormAction.DepositCollateralMultiply: {
      ...
      return makerActionDepositBorrow({
        state: {
          ...state,
          generateAmount:
            state.generateAmount && state.generateAmountMax
    ...
    case OmniMultiplyFormAction.WithdrawMultiply: {
      ...
      return makerActionPaybackWithdraw({
        state: {
          ...state,
          paybackAmount:
