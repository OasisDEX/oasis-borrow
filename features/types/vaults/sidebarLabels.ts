...
export type SidebarFlow = 'openBorrow' | 'manageBorrow' | 'openMultiply' | 'manageMultiply' | 'openGuni' | 'manageGuni' | 'addSl' | 'adjustSl' | 'cancelSl' | 'addBasicSell' | 'cancelBasicSell' | 'editBasicSell' | 'addBasicBuy' | 'cancelBasicBuy' | 'editBasicBuy' | 'addConstantMultiple'| 'cancelConstantMultiple'| 'editConstantMultiple' | 'confirmationAutoBuySell'
