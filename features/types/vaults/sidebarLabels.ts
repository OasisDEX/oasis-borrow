...
export type SidebarFlow = 'openBorrow' | 'manageBorrow' | 'openMultiply' | 'manageMultiply' | 'openGuni' | 'manageGuni' | 'addSl' | 'adjustSl' | 'cancelSl' | 'addBasicSell' | 'cancelBasicSell' | 'addBasicBuy' | 'cancelBasicBuy'
