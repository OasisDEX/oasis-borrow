...
export const subgraphsRecord: SubgraphsRecord = {
  Ajna: {
    [NetworkIds.MAINNET]: 'ajna-v2',
    [NetworkIds.HARDHAT]: 'ajna-v2',
    [NetworkIds.GOERLI]: 'ajna-v2',
    [NetworkIds.ARBITRUMMAINNET]: 'ajna-v2-arbitrum',
    [NetworkIds.ARBITRUMGOERLI]: '',
    [NetworkIds.BASEMAINNET]: 'ajna-v2-base',
    [NetworkIds.BASEGOERLI]: '',
    [NetworkIds.POLYGONMAINNET]: '',
    [NetworkIds.POLYGONMUMBAI]: '',
    [NetworkIds.OPTIMISMMAINNET]: 'ajna-v2-optimism',
