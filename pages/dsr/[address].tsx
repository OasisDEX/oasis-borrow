...
import { dsrContext, DsrContextProvider } from 'features/dsr/DsrContextProvider'
import { DsrManage } from 'features/dsr/containers/DsrManage'
...
function Position({ account }: { account: string }) {
  ...
  return (
    <DsrContextProvider>
      <DeferedContextProvider context={dsrContext}>
        <WithConnection>
          <WithTermsOfService>
            <DsrManage />
