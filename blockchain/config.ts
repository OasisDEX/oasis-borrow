...
const arbitrumGoerli: NetworkConfig = {
  id: '421613',
...
export const networksById = keyBy([main, kovan, hardhat, goerli, arbitrumGoerli], 'id')
export const networksByName = keyBy([main, kovan, hardhat, goerli, arbitrumGoerli], 'name')
