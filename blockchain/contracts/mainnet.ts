...
export const mainnetContracts = {
  ...
  joins: {
    ...getCollateralJoinContracts(mainnet.common, supportedIlks),
  },
  ...
  getCdps: contractDesc(getCdps, mainnet.maker.GetCdps),
  mcdJug: contractDesc(mcdJug, mainnet.maker.Jug),
  mcdPot: contractDesc(mcdPot, mainnet.maker.Pot),
  mcdEnd: contractDesc(mcdEnd, mainnet.maker.End),
  mcdSpot: contractDesc(mcdSpot, mainnet.maker.Spot),
  mcdDog: contractDesc(mcdDog, mainnet.maker.Dog),
  ...
  dssCdpManager: contractDesc(dssCdpManager, mainnet.maker.CdpManager),
  vat: contractDesc(vat, mainnet.maker.Vat),
  mcdJoinDai: contractDesc(mcdJoinDai, mainnet.maker.JoinDAI),
  ...
  fmm: mainnet.maker.FlashMintModule,
