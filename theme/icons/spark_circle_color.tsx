...
export const spark_circle_color = {
  path: (
    <>
      <g clipPath="url(#F)" transform="matrix(.846154 0 0 .846154 80.461538 80.461538)">
        <circle cx="523.2" cy="523.2" r="523.2" fill="#1b1713" />
        <path
      ...
      <defs>
        <linearGradient id="A" x1="145.957" y1="125.704" x2="406.32" y2="946.97">
          <stop stopColor="#f78e1e" />
          <stop offset="1" stopColor="#f2a529" />
        </linearGradient>
        <linearGradient id="B" x1="492.624" y1="64.972" x2="544.472" y2="886.794">
          <stop stopColor="#f78e1e" />
          <stop offset="1" stopColor="#f2a529" />
        </linearGradient>
        <linearGradient id="C" x1="659.43" y1="216.536" x2="729.976" y2="787.77">
          <stop stopColor="#f78e1e" />
          <stop offset="1" stopColor="#f2a529" />
        </linearGradient>
        <linearGradient id="D" x1="641.674" y1="104.415" x2="720.783" y2="917.064">
          <stop stopColor="#f78e1e" />
          <stop offset="1" stopColor="#f2a529" />
        </linearGradient>
        <linearGradient id="E" x1="209.132" y1="257.156" x2="526.916" y2="923.708">
          <stop stopColor="#f78e1e" />
          <stop offset="1" stopColor="#f2a529" />
        </linearGradient>
        <clipPath id="F">
          <rect width="1046" height="1046" rx="97" fill="#fff" />
        </clipPath>
