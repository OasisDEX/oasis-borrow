...
export const multiply_transition = {
  path: (
    <>
      <rect x="78" y="28" width="230" height="163" rx="16" fill="url(#paint0_linear_4681_33045)" />
      <rect x="78" y="28" width="230" height="163" rx="16" fill="url(#paint1_radial_4681_33045)" />
      <rect x="78" y="28" width="230" height="163" rx="16" fill="url(#paint2_radial_4681_33045)" />
      ...
      <rect opacity="0.8" x="22" y="134" width="110" height="20" rx="10" fill="#25273D" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <rect x="375" y="134" width="19" height="3" rx="1.5" fill="#BEC9D0" />
      <rect x="240" y="143" width="38" height="3" rx="1.5" fill="#EAEAEA" />
      <rect x="387" y="143" width="7" height="3" rx="1.5" fill="#BEC9D0" />
      <rect x="240" y="152" width="27" height="3" rx="1.5" fill="#EAEAEA" />
      <rect x="381" y="152" width="13" height="3" rx="1.5" fill="#BEC9D0" />
      <rect x="240" y="78" width="18" height="3" rx="1.5" fill="#EAEAEA" />
      <rect x="376" y="78" width="18" height="3" rx="1.5" fill="#EAEAEA" />
      <rect x="240" y="85" width="27" height="3" rx="1.5" fill="#787A9B" />
      ...
      <defs>
        ...
        >
          ...
          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_4681_33045" />
          <feBlend
            mode="normal"
            in="SourceGraphic"
        ...
        <radialGradient
          ...
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(80.3469 28) rotate(29.1405) scale(260.643 615.79)"
        >
