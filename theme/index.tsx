...
export const oasisBaseTheme = {
  ...
  colors: {
    ...
    onSuccess: 'success100',
    warning: 'warning10',
    onWarning: 'warning100',
    lavender: 'neutral80',
    lavender_o25: 'secondary100',
    banner: {
      warning: 'warning100',
      danger: 'critical100',
      muted: 'primary100',
      dangerBorder: 'warning10',
    },
    counter: {
      primary: 'warning100',
      secondary: 'warning100',
      surface: 'warning10',
    },
    bull: 'success100',
    bear: 'critical100',
    ...
    actionInputHover: 'secondary100',
    selected: 'interactive10',
    fogBlue: 'interactive30',
    maritimeBlue: 'primary100',
    newsletterInputBorder: 'secondary100',
  },
  fonts: {
