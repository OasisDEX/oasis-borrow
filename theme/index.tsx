...
export const GRADIENTS = {
  ...
  getStartedMultiply:
  'linear-gradient(127.5deg, #EEE1F9 0%, #FFECE8 56.77%, #DDFFF7 100%)',
  getStartedBorrow:
  'linear-gradient(127.5deg, #E4F9C9 0%, #E8FFF5 49.48%, #F9E1EB 100%)',
  getStartedManage:
  'linear-gradient(127.5deg, #DDFFF7 0%, #E8EAFF 61.98%, #F9E1EF 100%)'
}
