/*
  ...
  - A unique constraint covering the columns `[day_number,account_address,chain_id,source,type]` on the table `ajna_rewards_daily_claim` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "ajna_rewards_daily_claim_day_number_account_address_chain_i_key" ON "ajna_rewards_daily_claim"("day_number", "account_address", "chain_id", "source", "type");
