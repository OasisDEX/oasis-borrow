...
const cssPaths = {
  ...
  token1Btn: "div > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > button",
  token2Btn: "div > div:nth-child(2) > div:nth-child(2) > div:nth-child(3) > div > div:nth-child(2) > div:nth-child(1) > button",
}
...
export function UniswapWidget({ web3Provider }: { web3Provider?: provider}) {
  ...
  return web3Provider ? <Box sx={{
    ...
    <Flex sx={{ justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%'}}><AppSpinner /></Flex>
}